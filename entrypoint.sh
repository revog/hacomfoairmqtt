...
sed -i "s/\$VALUE_ENV_SERIAL_PORT\$/$SERIAL_PORT/g" config.ini config.ini
...
sed -i "s/\$VALUE_ENV_HA_AUTO_DISOCVERY_DEVICE_NAME\$/$HA_AUTO_DISOCVERY_DEVICE_NAME/g" config.ini
sed -i "s/\$VALUE_ENV_HA_AUTO_DISOCVERY_DEVICE_MANUFACTURER\$/$HA_AUTO_DISOCVERY_DEVICE_MANUFACTURER/g" config.ini
sed -i "s/\$VALUE_ENV_HA_AUTO_DISOCVERY_DEVICE_MODEL\$/$HA_AUTO_DISOCVERY_DEVICE_MODEL/g" config.ini
